...
Streamlit runs from `dashboard/Home.py` on port 18502. The new React app lives in [`../ui/`](../ui/README.md) and has its own `react-ui` CI job. The older removed SPA is preserved on `origin/archive/modern-web-spa-is-v15`.
