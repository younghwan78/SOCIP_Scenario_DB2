...
SYNTHETIC fixture: 15 seconds, UHD30 EIS, 450 frame starts, final video warp incomplete; not silicon measurement
...
statistics:
  ...
  - task: crta_3a
    includes_task_ids: []
    sample_unit: invocation
    min_ms: 0.294
    mean_ms: 0.29999999999999843
    max_ms: 0.306
    includes_hw_nodes: []
    samples: 450
  - task: post_crta
  ...
  - task: eis
    ...
    sample_unit: invocation
    min_ms: 3.136
    mean_ms: 3.199999999999989
    max_ms: 3.264
    includes_hw_nodes: []
    samples: 450
  hw_task_timing:
  - min_ms: 11.564
    mean_ms: 11.799999999999995
    max_ms: 12.036
    samples: 450
    task: sensor_readout
    node_id: sensor_rear
  ...
  sw_event_latency: []
  stage_timing: []
semantic_trace: uhd30-eis-15s.pftrace
...
```json
{
  ...
  "trace_sha256": "19092934e4c994ee2203f3d6b7692a95b4ea400f16da2daf3a40853616379370"
}
```
