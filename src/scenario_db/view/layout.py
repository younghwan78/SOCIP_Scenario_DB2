...
LANE_Y: dict[str, float] = {
    ...
    "external":  _lane_center_y(4),   # ~489
    "hw":        _lane_center_y(5),   # ~592
    "memory":    _lane_center_y(6),   # ~695
}
...
LANE_COLORS: dict[str, dict] = {
    ...
    "external":  {"start": "#94a3b8", "end": "#cbd5e1", "bg": "rgba(148,163,184,0.08)", "border": "#cbd5e1"},
...
LANE_LABEL_ORDER = ["app", "framework", "hal", "kernel", "external", "hw", "memory"]
LANE_DISPLAY_NAMES = {
    "app": "App", "framework": "Framework", "hal": "HAL",
    "kernel": "Kernel", "external": "External", "hw": "HW", "memory": "Buffer",
}
